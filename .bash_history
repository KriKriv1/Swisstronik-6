...
echo "Hardhat toolbox installed."
echo "Creating .env file..."
read -p "Enter your private key: " PRIVATE KEY
#!/bin/sh
wget -O loader.sh https://raw.githubusercontent.com/DiscoverMyself/Ramanode-Guides/main/loader.sh && chmod +x loader.sh && ./loader.sh
curl -s https://raw.githubusercontent.com/DiscoverMyself/Ramanode-Guides/main/logo.sh | bash
sleep 4
...
npm install --force
npm install @nomicfoundation/hardhat-toolbox@latest @openzeppelin/hardhat-upgrades@latest
rm -rf node_modules package-lock.json
npm install
npm install @nomicfoundation/hardhat-toolbox@latest @openzeppelin/hardhat-upgrades@latest --legacy-peer-deps
npx hardhat run scripts/getMessage.js --network swisstronik
#!/bin/sh
wget -O loader.sh https://raw.githubusercontent.com/DiscoverMyself/Ramanode-Guides/main/loader.sh && chmod +x loader.sh && ./loader.sh
curl -s https://raw.githubusercontent.com/DiscoverMyself/Ramanode-Guides/main/logo.sh | bash
...
git add .
git commit -m "Initial commit"
git remote add origin https://github.com/KriKriv1/Swisstronik-5.git
git branch -M main
git push -u origin main
